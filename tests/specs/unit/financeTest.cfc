	...
	function run(){
		describe('Finance Suite', function(){
			...
			it('can calculate IPMT', function() {
				...
				expect(fixer(val)).toBeCloseTo(-66.6666666666, 0.0000000001);
				//       excel:  -66.666666666666700000000000000000
            });
			it('can calculate IPMT', function() {
				var val = model.ipmt(0.10, 3, 3, 8000);
				expect(fixer(val)).toBeCloseTo(-292.4471299093, 0.0000000001);
			...
			it('can calculate NOMINAL', function() {
				...
				expect(fixer(val)).toBeCloseTo(0.0525003198, 0.0000000001);
