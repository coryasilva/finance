	...
	function run(){
		describe('Finance Suite', function(){
			...
			it('can calculate IPMT', function() {
				...
				expect(fixer(val)).toBeCloseTo(-66.6666666666, 0.000000001);
				//       excel:  -66.666666666666700000000000000000
            });
			it('can calculate IPMT', function() {
				var val = model.ipmt(0.10, 3, 3, 8000);
				expect(fixer(val)).toBeCloseTo(-292.4471299093, 0.000000001);
			...
			it('can calculate NOMINAL', function() {
				...
				expect(fixer(val)).toBeCloseTo(0.0525003198, 0.000000001);
			...
			*/
			it('can calculate LTV', function() {
				...
				expect(fixer(val)).toBeCloseTo(0.7500000000, 0.000000001);
				//       excel:  0.750000000000000000000000000000
            });
			it('can calculate LTV', function() {
				var val = model.ltv(200000, 300000);
				expect(fixer(val)).toBeCloseTo(0.6666666666, 0.000000001);
				//       excel:  0.666666666666667000000000000000
            });
			it('can calculate LTV', function() {
				var val = model.ltv(300000, -100000);
				expect(fixer(val)).toBeCloseTo(300000.0000000000, 0.000000001);
